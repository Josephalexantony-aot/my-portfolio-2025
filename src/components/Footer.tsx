...
const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-secondary-800 dark:bg-secondary-950 text-white py-12">
      <div className="container mx-auto px-4">
        ...
        <motion.div 
          className="border-t border-secondary-700 pt-8 flex flex-col md:flex-row justify-between items-center text-secondary-400 text-sm"
          initial={{ opacity: 0 }}
