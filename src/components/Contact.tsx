...
const Contact: React.FC = () => {
  ...
  const SERVICE_ID = "service_qc1niq2";
  const TEMPLATE_ID = "template_jld9xdc";
  const PUBLIC_KEY = "jowtsBdFQHl4ncDH4";
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          >
            ...
            <h6 className="text-2xl font-bold text-secondary-800 dark:text-white mb-6" >
              +91 7012440277 
            </h6>
            ...
            <div className="flex flex-wrap gap-4 mb-8">
              {socials.map((social) => (
                ...
                >
                  {social.icon === "github" && (
                    <svg
                      xmlns="https://github.com/Josephalexantony-aot"
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                      fill="none"
                  ...
                  {social.icon === "linkedin" && (
                    <svg
                      xmlns="linkedin.com/in/alex-antony-7272081a0"
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                      fill="none"
          ...
          >
            <form
              ...
              className="bg-white dark:bg-secondary-800 rounded-lg p-8 shadow-lg"
            >
              {formStatus && (
                <div
